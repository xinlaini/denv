...
call s:hifg("Normal","#C0C0C8","White",87)
if &background == "light" || has("gui_running")
    hi Normal guibg=#09091A ctermbg=Black
else
...
hi Search		guibg=darkgray guifg=black gui=bold ctermfg=black ctermbg=yellow
"highlight Search        guifg=NONE ctermfg=NONE gui=none cterm=none
"call s:hibg("Search"    ,"#555555","DarkBlue",77)
...
call s:hifg("Comment"        ,"#1FBAD6","DarkMagenta",34) " 92
" 26 instead?
